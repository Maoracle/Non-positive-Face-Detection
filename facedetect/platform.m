...
% PLATFORM M-file for platform.fig
...
%      applied to the GUI before platform_OpeningFunction gets called.  An
...
% Last Modified by GUIDE v2.5 13-Jan-2016 15:42:34
...
[filename,pathname]=...
     uigetfile({'*.tif';'*.png';'*.jpg'},'select picture');  %选择图片路径
